...
const Navbar = () => {
  ...
  const giveAlert = (e) => {
    e.preventDefault();
    alert('Sorry Buddy!, we are working on this');
  }
    ...
    <nav className="navbar fixed-top navbar-expand-lg bg-dark navbar-dark">
      <div className="container-fluid">
        ...
        <Link className="navbar-brand" to="/">
          ...
          <span className="mx-2">PocketNews</span>
        </Link>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0" id="navLinks">
            ...
            <li className="nav-item">
              <Link className="nav-link" aria-current="page" to="/worldNews" >
                World News
              </Link>
            </li>
          ...
          <form className="d-flex" role="search">
            <input
              ...
              aria-label="Search"
            />
            <button className="btn btn-outline-light" type="submit" onClick={giveAlert}>
              Search
            </button>
          </form>
        </div>
